...
export default function GenerateRecipeCard(): JSX.Element {
    return (
        <div className="flex flex-col sm:flex-row justify-between items-center rounded-lg bg-[#F0EFEB] py-4 px-6 mt-6 gap-4 animate-[slideInFade_0.5s_ease-out_forwards]">
